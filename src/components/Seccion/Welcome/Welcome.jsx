...
import cv from "../../../images/Santiago García CV.pdf";
    ...
    <>
      <div className={Styles.o_welcome}>
        <div className={Styles.o_socialcontainer}>
          ...
          <span className={Styles.o_dummysocial}></span>
        </div>
        <div className={Styles.o_container}>
          ...
          <div className={Styles.o_info}>
            ...
            <p className={Styles.o_profession}>
              Ingeniero Multimedia / Fullstack Developer
            </p>
            <p>
              ¡Hola! Soy Santiago García, una persona creativa, con iniciativa y
              me gusta trabajar en equipo. Como Desarrollador Web me he dedicado
              a crear productos con la capacidad de ofrecer experiencias
              interactivas multiplataforma.
              <br />
              <br />
              Desde que descubrí la programación, siempre procuro que mis
              desarrollos se adapten completamente a la necesidad de los
              usuarios, convirtiendose en sistemas dinámicos para todos.
            </p>
